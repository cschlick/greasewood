...
> **Multi-agent security review, conducted under an automated tool.** This session was
> auto-routed from one configuration to Opus 4.8 by the provider's safeguards on security content,
> so although the review was requested under one configuration, the analysis was performed by
